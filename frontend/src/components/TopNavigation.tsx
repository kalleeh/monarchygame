...
import { KingdomActionBarConnected } from './KingdomActionBar';
...
interface TopNavigationProps {
  ...
  subtitle?: string;
  /** When provided, renders the Kingdom/Warfare/Social action bar directly below this header */
  kingdomId?: string;
}
...
export const TopNavigation: React.FC<TopNavigationProps> = ({
  ...
  return (
    <>
      ...
      {/* Action bar renders immediately below the header when on a kingdom page */}
      {kingdomId && <KingdomActionBarConnected kingdomId={kingdomId} />}
    </>
  );
};
