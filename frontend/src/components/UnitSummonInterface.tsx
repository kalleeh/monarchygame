...
const getUnitImagePath = (unitId: string, _race: string): string => {
                ...
                <div key={unit.id} className="unit-card">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      if (!target.src.includes('unit-placeholder.png')) {
                        target.src = `/units/output/unit-placeholder.png`;
                      }
                    }}
                  />
            ...
            return (
              <div key={unitType.id} className="unit-type-card">
                <img 
                  ...
                  onError={(e) => {
                    const target = e.target as HTMLImageElement;
                    if (!target.src.includes('peasant-icon.png')) {
                      target.src = `/units/output/peasant-icon.png`;
                    }
                  }}
                />
