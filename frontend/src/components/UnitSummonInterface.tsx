...
/**
 * Maps unit IDs (generated by toId() in units.ts) to actual image filenames in /units/output/.
 * The images were generated with different naming conventions, so this bridges the gap.
 */
const UNIT_IMAGE_MAP: Record<string, string> = {
  // Human
  'peasants':              'human-peasants-icon.png',
  'militia':               'militia-icon.png',
  'knights':               'human-knights-icon.png',
  'cavalry':               'cavalry-icon.png',
  // Elven
  'elven-scouts':          'elven-scouts-icon.png',
  'elven-warriors':        'elven-rangers-icon.png',
  'elven-archers':         'elven-archers-icon.png',
  'elven-lords':           'elven-mages-icon.png',
  // Goblin
  'goblins':               'goblin-goblins-icon.png',
  'hobgoblins':            'goblin-assassins-icon.png',
  'kobolds':               'goblin-catapults-icon.png',
  'goblin-riders':         'goblin-wolf-riders-icon.png',
  // Droben
  'droben-warriors':       'droben-raiders-icon.png',
  'droben-berserkers':     'droben-berserkers-icon.png',
  'droben-bunar':          'droben-battle-axes-icon.png',
  'droben-champions':      'droben-war-chiefs-icon.png',
  // Vampire
  'thralls':               'vampire-thralls-icon.png',
  'vampire-spawn':         'vampire-vampires-icon.png',
  'vampire-lords':         'vampire-vampires-icon.png',
  'ancient-vampires':      'vampire-necromancers-icon.png',
  // Elemental
  'earth-elementals':      'elemental-earth-golems-icon.png',
  'fire-elementals':       'elemental-fire-sprites-icon.png',
  'water-elementals':      'elemental-water-spirits-icon.png',
  'air-elementals':        'elemental-air-elementals-icon.png',
  // Centaur
  'centaur-scouts':        'centaur-scouts-icon.png',
  'centaur-warriors':      'centaur-cavalry-icon.png',
  'centaur-archers':       'centaur-horse-archers-icon.png',
  'centaur-chiefs':        'centaur-spies-icon.png',
  // Sidhe
  'sidhe-nobles':          'sidhe-fae-warriors-icon.png',
  'sidhe-elders':          'sidhe-druids-icon.png',
  'sidhe-mages':           'sidhe-enchanters-icon.png',
  'sidhe-lords':           'sidhe-unicorns-icon.png',
  // Dwarven
  'dwarven-militia':       'dwarven-miners-icon.png',
  'dwarven-guards':        'dwarven-axe-guards-icon.png',
  'dwarven-warriors':      'dwarven-axe-throwers-icon.png',
  'dwarven-lords':         'dwarven-siege-engineers-icon.png',
  // Fae
  'fae-sprites':           'fae-sprites-icon.png',
  'fae-warriors':          'fae-forest-guardians-icon.png',
  'fae-nobles':            'fae-treants-icon.png',
  'fae-lords':             'fae-unicorns-icon.png',
};

const getUnitImagePath = (unitId: string, _race: string): string => {
  const mapped = UNIT_IMAGE_MAP[unitId];
  if (mapped) return `/units/output/${mapped}`;
  // Fallback: try the ID directly
