...
function pageKingdomToKingdom(k: KingdomPage['kingdoms'][number]): Kingdom {
  return {
    ...
    stats: {
      ...
      previousSeasonRank: k.stats.previousSeasonRank !== 0 ? k.stats.previousSeasonRank : undefined,
      previousSeasonNetworth: k.stats.previousSeasonNetworth !== 0 ? k.stats.previousSeasonNetworth : undefined,
      previousSeasonNumber: k.stats.previousSeasonNumber !== 0 ? k.stats.previousSeasonNumber : undefined,
    },
