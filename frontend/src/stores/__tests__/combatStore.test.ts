...
describe('CombatStore', () => {
  beforeEach(() => {
    // Reset combatStore to initial state
    ...
    // Reset formationStore to initial state
  ...
  it('should initialize formation store with default values', () => {
  ...
  it('should create formations', () => {
    const { createFormation } = useFormationStore.getState();
  ...
  it('should manage active formation', () => {
    const { setActiveFormation } = useFormationStore.getState();

    setActiveFormation('defensive-wall');
    expect(useFormationStore.getState().activeFormation).toBe('defensive-wall');

    setActiveFormation(null);
    expect(useFormationStore.getState().activeFormation).toBeNull();
  });

  it('should update formation positions', () => {
    const { createFormation, updateFormationPositions } = useFormationStore.getState();
    ...
    const formation = useFormationStore.getState().formations.find(f => f.id === formationId);
  ...
  it('should manage UI state', () => {
    ...
    // Test setShowFormationEditor action method
    setShowFormationEditor(true);
    expect(useFormationStore.getState().showFormationEditor).toBe(true);

    setShowFormationEditor(false);
    expect(useFormationStore.getState().showFormationEditor).toBe(false);
